...
- **계층적 에이전트 아키텍처:** 중앙 감독관 에이전트(`TopikWritingEvaluator`)가 사용자 요청을 분석하여 가장 적합한 전문 채점 에이전트에게 작업을 분배하는 구조를 가집니다.

## 기술 스택

- **Frontend:** Next.js (15v), React, TypeScript, Tailwind CSS, shadcn/ui, ky
