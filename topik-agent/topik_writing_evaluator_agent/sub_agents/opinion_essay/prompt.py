...
SCORING_GUIDE = "54번: 내용_과제수행(task_performance - 12점), 전개_구조(structure - 12점), 언어_사용(language_use - 26점) = 총 50점"
...
[출력]
{
  ...
  "total_score": 50,
  "char_count": 664,
  "char_count_evaluation": "적정 범위 (664자, 600~700자)",
  "strengths": [
